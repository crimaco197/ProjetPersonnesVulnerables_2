 ...
 * @author hp
 */
public class Vlistrequest extends javax.swing.JFrame {

    /**
     * Creates new form Vlistrequest
     */
    public Vlistrequest() {
        initComponents();
    }
    ...
    private void bttaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttaddActionPerformed
        // TODO add your handling code here:
        if(txtname.getText().equals("") || txttitre.getText().equals("") ){
            JOptionPane.showMessageDialog(this , "enter all data");
        }else{
            String data[]= {txtname.getText(), txttitre.getText()};
...
//            java.util.logging.Logger.getLogger(Vlistrequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Vlistrequest().setVisible(true);
//            }
//        });
//    }
